...
var slide = document.querySelector('.header-announcement__items');
var interval = 3000;
var slides = document.querySelectorAll('.header-announcement__item');
var index = 1;
...
slide.style.transform = "translateX(".concat(-slideWidth * index, "px)");
...
var getSlides = function getSlides() {
  return document.querySelectorAll('.header-announcement__item');
};
...
/***/ "./assets/src/js/filter-collection.js":
/*!********************************************!*\
  !*** ./assets/src/js/filter-collection.js ***!
  \********************************************/
/***/ (() => {
...
jQuery(document).ready(function ($) {
  ...
  var $menuMobileFixed = $('.menu-mobile-fixed');
  var $dataOpenMenuFixed = $('[data-open-menu-fixed]');
  var $dataCloseMenuFixed = $('[data-close-menu-fixed]');
  var $hasChild = $('.has-child button');
  var $timerSet = null;
  ...
  // Menu Mobile Fixed
  $dataOpenMenuFixed.on('click', function () {
    $menuMobileFixed.addClass('is-active');
    $('.menu-mobile-fixed__menu-item').each(function (i) {
      $timerSet = setTimeout(function () {
        $('.menu-mobile-fixed__menu-item').eq(i).addClass('is-showing');
      }, 100 * (i + 1));
    });
  });
  $dataCloseMenuFixed.on('click', function () {
    clearTimeout($timerSet);
    $('.menu-mobile-fixed__menu-item').removeClass('is-showing');
    $menuMobileFixed.removeClass('is-active');
  });
...
/***/ "./assets/src/js/locomotive-scroll.js":
/*!********************************************!*\
  !*** ./assets/src/js/locomotive-scroll.js ***!
  \********************************************/
...
jQuery(document).ready(function ($) {
  function modalPopup() {
    $('[data-popup-subscribe]').fadeIn();
    $('.close').on('click', function () {
      sessionStorage.setItem('isHideModalPopup', true);
      $('[data-popup-subscribe]').fadeOut();
    });
  }
  $('[data-close-popup-subscribe], #mc-embedded-subscribe').on('click', function () {
    $('[data-popup-subscribe]').fadeOut();
    sessionStorage.setItem('isHideModalPopup', true);
  });
  if (sessionStorage.getItem('isHideModalPopup') !== 'true') {
    setTimeout(function () {
      modalPopup();
    }, 5000);
  }
...
/* harmony import */ var _announcement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./announcement */ "./assets/src/js/announcement.js");
/* harmony import */ var _announcement__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_announcement__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header */ "./assets/src/js/header.js");
...
/* harmony import */ var _filter_collection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter-collection */ "./assets/src/js/filter-collection.js");
/* harmony import */ var _filter_collection__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_filter_collection__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./popup */ "./assets/src/js/popup.js");
...
jQuery(document).ready(function ($) {
  ...
  var counter = setInterval(function () {
    if (count <= 100) {
      $('.loader-text').text(count + '%');
      $('.loader-box').css('width', count + '%');
      count++;
    } else {
