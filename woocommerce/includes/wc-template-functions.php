...
function wc_get_privacy_policy_text( $type = '' ) {
	...
	switch ( $type ) {
		case 'checkout':
			...
			$text = get_option( 'woocommerce_checkout_privacy_policy_text', sprintf( __( 'Sus datos personales se utilizarán para respaldar su experiencia en este sitio web, para administrar el acceso a su cuenta y para otros fines descritos en nuestro %s.', 'woocommerce' ), '[privacy_policy]' ) );
			break;
		case 'registration':
			/* translators: %s privacy policy page name and link */
			$text = get_option( 'woocommerce_registration_privacy_policy_text', sprintf( __( 'Sus datos personales se utilizarán para respaldar su experiencia en este sitio web, para administrar el acceso a su cuenta y para otros fines descritos en nuestro %s.', 'woocommerce' ), '[privacy_policy]' ) );
			break;
	}
...
function woocommerce_output_all_notices() {
	echo '<div data-scroll-section class="woocommerce-notices-wrapper">';
	wc_print_notices();
	echo '</div>';
}
